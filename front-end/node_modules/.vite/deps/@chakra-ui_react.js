...
function useVisualElement(Component2, visualState, props, createVisualElement2) {
  ...
  const useAnimateChangesEffect = window.HandoffAppearAnimations ? useIsomorphicLayoutEffect : import_react10.useEffect;
...
function useIsPresent() {
  return isPresent((0, import_react21.useContext)(PresenceContext));
}
...
function MeasureLayout(props) {
  ...
  return import_react22.default.createElement(MeasureLayoutWithContext, { ...props, layoutGroup, switchLayoutGroup: (0, import_react22.useContext)(SwitchLayoutGroupContext), isPresent: isPresent2, safeToRemove });
}
...
var AnimatePresence = ({ children, custom, initial = true, onExitComplete, exitBeforeEnter, presenceAffectsLayout = true, mode = "sync" }) => {
  ...
  return React4.createElement(React4.Fragment, null, exitingChildren.size ? childrenToRender : childrenToRender.map((child) => (0, import_react28.cloneElement)(child)));
};
...
function ReorderItem({ children, style = {}, value, as = "li", onDrag, layout: layout3 = true, ...props }, externalRef) {
  ...
  const measuredLayout = (0, import_react36.useRef)(null);
...
var ToastComponent = (0, import_react49.memo)((props) => {
  const {
    id: id3,
    message,
    onCloseComplete,
  ...
  const [delay2, setDelay] = (0, import_react49.useState)(duration);
  ...
  const containerStyles = (0, import_react49.useMemo)(
    () => ({
      pointerEvents: "auto",
      maxWidth: 560,
      minWidth: 300,
  ...
  const toastStyle = (0, import_react49.useMemo)(() => getToastStyle(position2), [position2]);
...
function useDescendants() {
  const descendants = (0, import_react53.useRef)(new DescendantsManager());
...
function useDescendant(options) {
  ...
  const [index2, setIndex] = (0, import_react53.useState)(-1);
...
function useAccordionItem(props) {
  ...
  const onFocus3 = (0, import_react54.useCallback)(() => {
    setFocusedIndex(index2);
  }, [setFocusedIndex, index2]);
  const getButtonProps = (0, import_react54.useCallback)(
  ...
  const getPanelProps = (0, import_react54.useCallback)(
...
var AccordionItem = forwardRef(
  function AccordionItem2(props, ref) {
    ...
    const ctx = (0, import_react55.useMemo)(() => context, [context]);
...
var Collapse = (0, import_react56.forwardRef)(
  (props, ref) => {
    const {
      in: isOpen,
      unmountOnExit,
...
var Fade = (0, import_react57.forwardRef)(function Fade2(props, ref) {
  const {
    unmountOnExit,
    in: isOpen,
    className,
...
var ScaleFade = (0, import_react58.forwardRef)(
...
var SlideFade = (0, import_react59.forwardRef)(
...
var Accordion = forwardRef(function Accordion2({ children, reduceMotion, ...props }, ref) {
  ...
  const ctx = (0, import_react61.useMemo)(
...
function AvatarImage(props) {
  ...
  if (showFallback) {
    ...
    ) : (0, import_react62.cloneElement)(icon, {
      role: "img",
...
var Avatar = forwardRef((props, ref) => {
  ...
  const [isLoaded, setIsLoaded] = (0, import_react63.useState)(false);
  const {
    src,
    srcSet,
    name,
...
var AvatarGroup = forwardRef(
  function AvatarGroup2(props, ref) {
    ...
    const clones = reversedChildren.map((child, index2) => {
      ...
      return (0, import_react64.cloneElement)(child, compact2(childProps));
    });
    const groupStyles = {
      display: "flex",
      alignItems: "center",
...
var IconButton = forwardRef(
  (props, ref) => {
    ...
    const _children = (0, import_react72.isValidElement)(element) ? (0, import_react72.cloneElement)(element, {
      "aria-hidden": true,
      focusable: false
    }) : null;
...
function useCounter(props = {}) {
  ...
  const [valueState, setValue] = (0, import_react73.useState)(() => {
    var _a2;
  ...
  const update = (0, import_react73.useCallback)(
    (next) => {
      if (next === value)
        return;
      if (!isControlled) {
  ...
  const clamp2 = (0, import_react73.useCallback)(
    (value2) => {
  ...
  const increment = (0, import_react73.useCallback)(
    (step = stepProp) => {
      let next;
      if (value === "") {
        next = parse(step);
  ...
  const decrement = (0, import_react73.useCallback)(
    (step = stepProp) => {
      let next;
      if (value === "") {
        next = parse(-step);
  ...
  const castValue = (0, import_react73.useCallback)(
    (value2) => {
      var _a2;
...
function useEditable(props = {}) {
  ...
  const [isEditing, setIsEditing] = (0, import_react75.useState)(defaultIsEditing);
  const [value, setValue] = useControllableState({
    defaultValue: defaultValue || "",
    value: valueProp,
    onChange: onChangeProp
  });
  const [prevValue, setPrevValue] = (0, import_react75.useState)(value);
  const inputRef = (0, import_react75.useRef)(null);
  const previewRef = (0, import_react75.useRef)(null);
  const editButtonRef = (0, import_react75.useRef)(null);
  const cancelButtonRef = (0, import_react75.useRef)(null);
  const submitButtonRef = (0, import_react75.useRef)(null);
  ...
  const onEdit = (0, import_react75.useCallback)(() => {
    if (isInteractive) {
      setIsEditing(true);
    }
  }, [isInteractive]);
  const onUpdatePrevValue = (0, import_react75.useCallback)(() => {
    setPrevValue(value);
  }, [value]);
  const onCancel = (0, import_react75.useCallback)(() => {
    setIsEditing(false);
    setValue(prevValue);
    onCancelProp == null ? void 0 : onCancelProp(prevValue);
    onBlurProp == null ? void 0 : onBlurProp(prevValue);
  }, [onCancelProp, onBlurProp, setValue, prevValue]);
  const onSubmit = (0, import_react75.useCallback)(() => {
    setIsEditing(false);
    setPrevValue(value);
  ...
  const onKeyDownWithoutSubmit = (0, import_react75.useCallback)(
    (event) => {
      const eventKey = event.key;
      const keyMap = {
        Escape: onCancel
  ...
  const onBlur3 = (0, import_react75.useCallback)(
    (event) => {
      var _a2;
      if (!isEditing)
        return;
  ...
  const getPreviewProps = (0, import_react75.useCallback)(
    (props2 = {}, ref = null) => {
  ...
  const getTextareaProps = (0, import_react75.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      hidden: !isEditing,
      placeholder,
  ...
  const getEditButtonProps = (0, import_react75.useCallback)(
    (props2 = {}, ref = null) => ({
      "aria-label": "Edit",
      ...props2,
      type: "button",
  ...
  const getSubmitButtonProps = (0, import_react75.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      "aria-label": "Submit",
  ...
  const getCancelButtonProps = (0, import_react75.useCallback)(
    (props2 = {}, ref = null) => ({
      "aria-label": "Cancel",
      id: "cancel",
      ...props2,
...
function useWhyDidYouUpdate(name, props) {
  const previousProps = (0, import_react87.useRef)();
...
function useMouseDownRef(shouldListen = true) {
  const mouseDownRef = (0, import_react92.useRef)();
...
function usePanGesture(ref, props) {
  ...
  const panSession = (0, import_react95.useRef)(null);
  const handlers = {
...
function useId5(idProp, prefix) {
  const id3 = (0, import_react96.useId)();
...
function useOptionalPart(partId) {
  const [id3, setId] = (0, import_react96.useState)(null);
  const ref = (0, import_react96.useCallback)(
    (node2) => {
...
function useControllableState2(props) {
  ...
  const [valueState, setValue] = (0, import_react97.useState)(defaultValue);
  const isControlled = valueProp !== void 0;
  const value = isControlled ? valueProp : valueState;
  const updateValue = (0, import_react97.useCallback)(
    (next) => {
...
function useEventListenerMap() {
  const listeners = (0, import_react99.useRef)(/* @__PURE__ */ new Map());
  const currentListeners = listeners.current;
  const add = (0, import_react99.useCallback)((el, type, listener, options) => {
  ...
  const remove = (0, import_react99.useCallback)(
...
var useUpdateEffect2 = (effect5, deps) => {
  const renderCycleRef = (0, import_react100.useRef)(false);
  const effectCycleRef = (0, import_react100.useRef)(false);
...
function useFocusOnShow(target, options = defaultOptions) {
  ...
  const autoFocusRef = (0, import_react101.useRef)(autoFocusValue);
  const lastVisibleRef = (0, import_react101.useRef)(visible);
  useSafeLayoutEffect3(() => {
...
function useForceUpdate2() {
  const unloadingRef = (0, import_react102.useRef)(false);
  const [count, setCount] = (0, import_react102.useState)(0);
  useUnmountEffect2(() => {
    unloadingRef.current = true;
  });
  return (0, import_react102.useCallback)(() => {
...
function useAnimationState(props) {
  ...
  const [mounted, setMounted] = (0, import_react103.useState)(isOpen);
  const [once, setOnce] = (0, import_react103.useState)(false);
...
function useBoolean(initialState2 = false) {
  const [value, setValue] = (0, import_react104.useState)(initialState2);
  const callbacks = (0, import_react104.useMemo)(
    () => ({
      on: () => setValue(true),
      off: () => setValue(false),
...
function useClipboard(value, optionsOrTimeout = {}) {
  const [hasCopied, setHasCopied] = (0, import_react105.useState)(false);
  const [valueState, setValueState] = (0, import_react105.useState)(value);
  (0, import_react105.useEffect)(() => setValueState(value), [value]);
  const { timeout = 1500, ...copyOptions } = typeof optionsOrTimeout === "number" ? { timeout: optionsOrTimeout } : optionsOrTimeout;
  const onCopy = (0, import_react105.useCallback)(() => {
...
function useDimensions(ref, observe) {
  const [dimensions, setDimensions] = (0, import_react107.useState)(null);
  const rafId = (0, import_react107.useRef)();
  useSafeLayoutEffect3(() => {
    function measure() {
      const node2 = ref.current;
      if (!node2)
...
var InputGroup = forwardRef(
  function InputGroup2(props, ref) {
    ...
    const clones = validChildren.map((child) => {
      ...
      return child.type.id !== "Input" ? (0, import_react108.cloneElement)(child, theming) : (0, import_react108.cloneElement)(child, Object.assign(theming, groupStyles, child.props));
    });
...
function useMediaQuery(query, options = {}) {
  ...
  const [value, setValue] = (0, import_react109.useState)(() => {
...
function useShortcut2(props = {}) {
  const { timeout = 300, preventDefault = () => true } = props;
  const [keys, setKeys] = (0, import_react110.useState)([]);
  const timeoutRef = (0, import_react110.useRef)();
  const flush = () => {
    if (timeoutRef.current) {
      clearTimeout(timeoutRef.current);
      timeoutRef.current = null;
  ...
  (0, import_react110.useEffect)(() => flush, []);
  function onKeyDown(fn2) {
    return (event) => {
      if (event.key === "Backspace") {
        const keysCopy = [...keys];
...
function useClickable(props = {}) {
  ...
  const [isButton, setIsButton] = (0, import_react112.useState)(true);
  const [isPressed, setIsPressed] = (0, import_react112.useState)(false);
  ...
  const handleClick = (0, import_react112.useCallback)(
    (event) => {
      if (isDisabled2) {
        event.stopPropagation();
        event.preventDefault();
  ...
  const onDocumentKeyUp = (0, import_react112.useCallback)(
    (e) => {
  ...
  const handleKeyDown = (0, import_react112.useCallback)(
    (event) => {
  ...
  const handleKeyUp = (0, import_react112.useCallback)(
    (event) => {
  ...
  const onDocumentMouseUp = (0, import_react112.useCallback)(
    (event) => {
      if (event.button !== 0)
        return;
      setIsPressed(false);
  ...
  const handleMouseDown = (0, import_react112.useCallback)(
    (event) => {
      if (event.button !== 0)
        return;
      if (isDisabled2) {
  ...
  const handleMouseUp = (0, import_react112.useCallback)(
    (event) => {
      if (event.button !== 0)
        return;
      if (!isButton) {
  ...
  const handleMouseOver = (0, import_react112.useCallback)(
    (event) => {
      if (isDisabled2) {
        event.preventDefault();
        return;
  ...
  const handleMouseLeave = (0, import_react112.useCallback)(
    (event) => {
      if (isPressed) {
        event.preventDefault();
        setIsPressed(false);
...
function useDisclosure2(props = {}) {
  ...
  const uid = (0, import_react115.useId)();
...
function useOutsideClick2(props) {
  ...
  const stateRef = (0, import_react116.useRef)({
    isPointerDown: false,
    ignoreEmulatedMouseEvents: false
  });
  const state = stateRef.current;
...
function useMenu(props = {}) {
  ...
  const menuRef = (0, import_react118.useRef)(null);
  const buttonRef = (0, import_react118.useRef)(null);
  const descendants = useMenuDescendants();
  const focusMenu = (0, import_react118.useCallback)(() => {
    requestAnimationFrame(() => {
      var _a2;
      (_a2 = menuRef.current) == null ? void 0 : _a2.focus({ preventScroll: false });
    });
  }, []);
  const focusFirstItem = (0, import_react118.useCallback)(() => {
  ...
  const focusLastItem = (0, import_react118.useCallback)(() => {
    const id22 = setTimeout(() => {
      const last = descendants.lastEnabled();
      if (last)
  ...
  const onOpenInternal = (0, import_react118.useCallback)(() => {
  ...
  const openAndFocusMenu = (0, import_react118.useCallback)(() => {
    onOpen();
    focusMenu();
  }, [onOpen, focusMenu]);
  const timeoutIds = (0, import_react118.useRef)(/* @__PURE__ */ new Set([]));
  useUnmountEffect3(() => {
    timeoutIds.current.forEach((id22) => clearTimeout(id22));
    timeoutIds.current.clear();
  });
  const openAndFocusFirstItem = (0, import_react118.useCallback)(() => {
    onOpen();
    focusFirstItem();
  }, [focusFirstItem, onOpen]);
  const openAndFocusLastItem = (0, import_react118.useCallback)(() => {
    onOpen();
    focusLastItem();
  }, [onOpen, focusLastItem]);
  const refocus = (0, import_react118.useCallback)(() => {
    var _a2, _b;
  ...
  const rafId = (0, import_react118.useRef)(null);
  return {
    openAndFocusMenu,
...
function useMenuList(props = {}, ref = null) {
  ...
  const hasBeenOpened = (0, import_react118.useRef)(false);
  if (isOpen) {
...
function useMenuItem(props = {}, externalRef = null) {
  ...
  const id3 = `${menuId}-menuitem-${(0, import_react118.useId)()}`;
  const { index: index2, register } = useMenuDescendant({
    disabled: isDisabled2 && !isFocusable2
  });
  const onMouseEnter = (0, import_react118.useCallback)(
    (event) => {
  ...
  const onMouseMove = (0, import_react118.useCallback)(
    (event) => {
  ...
  const onMouseLeave = (0, import_react118.useCallback)(
    (event) => {
  ...
  const onClick = (0, import_react118.useCallback)(
    (event) => {
...
var Menu = (props) => {
  ...
  const context = (0, import_react119.useMemo)(() => ctx, [ctx]);
...
var MenuIcon = (props) => {
  ...
  const clone = (0, import_react121.isValidElement)(child) ? (0, import_react121.cloneElement)(child, {
    focusable: "false",
    "aria-hidden": true,
...
var ModalTransition = (0, import_react122.forwardRef)(
  (props, ref) => {
...
function useModalManager(ref, isOpen) {
  const [index2, setIndex] = (0, import_react123.useState)(0);
...
function useModal(props) {
  ...
  const dialogRef = (0, import_react124.useRef)(null);
  const overlayRef = (0, import_react124.useRef)(null);
  ...
  const mouseDownTarget = (0, import_react124.useRef)(null);
  const onMouseDown = (0, import_react124.useCallback)((event) => {
  ...
  const [headerMounted, setHeaderMounted] = (0, import_react124.useState)(false);
  const [bodyMounted, setBodyMounted] = (0, import_react124.useState)(false);
  const getDialogProps = (0, import_react124.useCallback)(
    (props2 = {}, ref = null) => ({
      role: "dialog",
      ...props2,
  ...
  const onOverlayClick = (0, import_react124.useCallback)(
    (event) => {
      event.stopPropagation();
  ...
  const getDialogContainerProps = (0, import_react124.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
...
function useSpinner(increment, decrement) {
  const [isSpinning, setIsSpinning] = (0, import_react130.useState)(false);
  const [action, setAction] = (0, import_react130.useState)(null);
  const [runOnce, setRunOnce] = (0, import_react130.useState)(true);
  const timeoutRef = (0, import_react130.useRef)(null);
  ...
  const up = (0, import_react130.useCallback)(() => {
    if (runOnce) {
      increment();
    }
    timeoutRef.current = setTimeout(() => {
  ...
  const down = (0, import_react130.useCallback)(() => {
    if (runOnce) {
      decrement();
    }
    timeoutRef.current = setTimeout(() => {
  ...
  const stop = (0, import_react130.useCallback)(() => {
    setRunOnce(true);
    setIsSpinning(false);
    removeTimeout();
  }, []);
...
function useNumberInput(props = {}) {
  ...
  const [isFocused, setFocused] = (0, import_react131.useState)(false);
  const isInteractive = !(isReadOnly || isDisabled2);
  const inputRef = (0, import_react131.useRef)(null);
  const inputSelectionRef = (0, import_react131.useRef)(null);
  const incrementButtonRef = (0, import_react131.useRef)(null);
  const decrementButtonRef = (0, import_react131.useRef)(null);
  const sanitize2 = (0, import_react131.useCallback)(
    (value) => value.split("").filter(isValidCharacter).join(""),
    [isValidCharacter]
  );
  const parse3 = (0, import_react131.useCallback)(
    (value) => {
      var _a2;
  ...
  const format = (0, import_react131.useCallback)(
    (value) => {
      var _a2;
  ...
  const increment = (0, import_react131.useCallback)(
    (step = stepProp) => {
      if (isInteractive) {
        incrementFn(step);
      }
  ...
  const decrement = (0, import_react131.useCallback)(
    (step = stepProp) => {
      if (isInteractive) {
        decrementFn(step);
      }
  ...
  const _onFocus = (0, import_react131.useCallback)(
    (event) => {
      var _a2, _b, _c;
  ...
  const ariaValueText = (0, import_react131.useMemo)(() => {
  ...
  const validateAndClamp = (0, import_react131.useCallback)(() => {
  ...
  const onInputBlur = (0, import_react131.useCallback)(() => {
    setFocused(false);
    if (clampValueOnBlur) {
      validateAndClamp();
    }
  ...
  const spinUp = (0, import_react131.useCallback)(
    (event) => {
      event.preventDefault();
      spinner.up();
      focusInput();
  ...
  const spinDown = (0, import_react131.useCallback)(
    (event) => {
      event.preventDefault();
      spinner.down();
      focusInput();
  ...
  const getIncrementButtonProps = (0, import_react131.useCallback)(
    (props2 = {}, ref = null) => {
  ...
  const getDecrementButtonProps = (0, import_react131.useCallback)(
    (props2 = {}, ref = null) => {
  ...
  const getInputProps = (0, import_react131.useCallback)(
    (props2 = {}, ref = null) => {
      var _a2, _b, _c, _d;
      return {
        name,
...
var NumberInput = forwardRef(
  function NumberInput2(props, ref) {
    ...
    const ctx = (0, import_react132.useMemo)(() => context, [context]);
...
function usePinInput(props = {}) {
  ...
  const [moveFocus, setMoveFocus] = (0, import_react133.useState)(true);
  const [focusedIndex, setFocusedIndex] = (0, import_react133.useState)(-1);
  ...
  const focusNext = (0, import_react133.useCallback)(
    (index2) => {
  ...
  const getNextValue = (0, import_react133.useCallback)((value2, eventValue) => {
...
function PinInput(props) {
  ...
  const clones = getValidChildren(children).map(
    (child) => (0, import_react134.cloneElement)(child, { __css: styles })
  );
...
function PopoverTrigger(props) {
  const child = import_react135.Children.only(props.children);
  const { getTriggerProps } = usePopoverContext();
  return (0, import_react135.cloneElement)(child, getTriggerProps(child.props, child.ref));
}
...
function usePopover(props = {}) {
  ...
  const anchorRef = (0, import_react136.useRef)(null);
  const triggerRef = (0, import_react136.useRef)(null);
  const popoverRef = (0, import_react136.useRef)(null);
  const isHoveringRef = (0, import_react136.useRef)(false);
  const hasBeenOpened = (0, import_react136.useRef)(false);
  if (isOpen) {
    hasBeenOpened.current = true;
  }
  const [hasHeader, setHasHeader] = (0, import_react136.useState)(false);
  const [hasBody, setHasBody] = (0, import_react136.useState)(false);
  ...
  const getPopoverProps = (0, import_react136.useCallback)(
    (props2 = {}, _ref2 = null) => {
      const popoverProps = {
        ...props2,
        style: {
  ...
  const getPopoverPositionerProps = (0, import_react136.useCallback)(
  ...
  const getAnchorProps = (0, import_react136.useCallback)(
    (props2, _ref2 = null) => {
      return {
        ...props2,
  ...
  const openTimeout = (0, import_react136.useRef)();
  const closeTimeout = (0, import_react136.useRef)();
  const maybeReferenceRef = (0, import_react136.useCallback)(
    (node2) => {
  ...
  const getHeaderProps = (0, import_react136.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      id: headerId,
  ...
  const getBodyProps = (0, import_react136.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      id: bodyId,
      ref: mergeRefs(ref, (node2) => {
...
function PopoverAnchor(props) {
  const child = import_react137.Children.only(props.children);
  const { getAnchorProps } = usePopoverContext();
  return (0, import_react137.cloneElement)(child, getAnchorProps(child.props, child.ref));
}
...
function useRadioGroup(props = {}) {
  ...
  const [valueState, setValue] = (0, import_react138.useState)(defaultValue || "");
  const isControlled = typeof valueProp !== "undefined";
  const value = isControlled ? valueProp : valueState;
  const ref = (0, import_react138.useRef)(null);
  const focus2 = (0, import_react138.useCallback)(() => {
  ...
  const getRootProps = (0, import_react138.useCallback)(
  ...
  const getRadioProps = (0, import_react138.useCallback)(
    (props2 = {}, ref2 = null) => {
...
var RadioGroup = forwardRef((props, ref) => {
  ...
  const group = (0, import_react139.useMemo)(
    () => ({
      name,
      size,
      onChange,
...
function useRadio(props = {}) {
  ...
  const uuid = `radio-${(0, import_react140.useId)()}`;
  ...
  const [isFocusVisible, setIsFocusVisible] = (0, import_react140.useState)(false);
  const [isFocused, setFocused] = (0, import_react140.useState)(false);
  const [isHovered, setHovering] = (0, import_react140.useState)(false);
  const [isActive, setActive] = (0, import_react140.useState)(false);
  const [isCheckedState, setChecked] = (0, import_react140.useState)(Boolean(defaultChecked));
  const isControlled = typeof isCheckedProp !== "undefined";
  const isChecked = isControlled ? isCheckedProp : isCheckedState;
  (0, import_react140.useEffect)(() => {
    return trackFocusVisible(setIsFocusVisible);
  }, []);
  const handleChange = (0, import_react140.useCallback)(
    (event) => {
  ...
  const onKeyUp = (0, import_react140.useCallback)(
    (event) => {
      if (event.key === " ") {
        setActive(false);
      }
  ...
  const getRadioProps = (0, import_react140.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      ref,
      "data-active": dataAttr(isActive),
...
var SelectIcon = (props) => {
  ...
  const clone = (0, import_react141.cloneElement)(children, {
    role: "presentation",
  ...
  return (0, import_jsx_runtime101.jsx)(IconWrapper, { ...rest, className: "chakra-select__icon-wrapper", children: (0, import_react141.isValidElement)(children) ? clone : null });
};
...
function usePrevious2(value) {
  const ref = (0, import_react143.useRef)();
...
var SkeletonText = (props) => {
  ...
  return (0, import_jsx_runtime104.jsx)(chakra.div, { className: _className, ...rest, children: numbers.map((number2, index2) => {
...
function usePanEvent(ref, options) {
  ...
  const panSession = (0, import_react145.useRef)(null);
...
var useSafeLayoutEffect4 = Boolean(globalThis == null ? void 0 : globalThis.document) ? import_react146.useLayoutEffect : import_react146.useEffect;
...
function useSizes({
  ...
  const [sizes, setSizes] = (0, import_react146.useState)([]);
...
var Stepper = forwardRef(function Stepper2(props, ref) {
  ...
  const stepElements = import_react150.Children.toArray(children);
  ...
  return (0, import_jsx_runtime116.jsx)(
    chakra.div,
    {
      ...
      children: (0, import_jsx_runtime116.jsx)(StepperStylesProvider, { value: styles, children: stepElements.map((child, index22) => (0, import_jsx_runtime116.jsx)(
        StepContextProvider,
        {
          value: {
            index: index22,
...
function useSteps(props = {}) {
  ...
  const [activeStep, setActiveStep] = (0, import_react151.useState)(index2);
...
var Switch = forwardRef(function Switch2(props, ref) {
  ...
  const containerStyles = (0, import_react152.useMemo)(
    () => ({
      display: "inline-block",
      position: "relative",
      verticalAlign: "middle",
  ...
  const trackStyles = (0, import_react152.useMemo)(
    () => ({
      display: "inline-flex",
      flexShrink: 0,
  ...
  const labelStyles = (0, import_react152.useMemo)(
    () => ({
      userSelect: "none",
      marginStart: spacing,
      ...styles.label
...
function useTabs(props) {
  ...
  const [focusedIndex, setFocusedIndex] = (0, import_react153.useState)(defaultIndex != null ? defaultIndex : 0);
...
function useTabPanels(props) {
  ...
  const children = validChildren.map(
    (child, index2) => (0, import_react153.createElement)(
      TabPanelProvider,
      {
        key: index2,
        value: {
...
function useTabPanel(props) {
  ...
  const hasBeenSelected = (0, import_react153.useRef)(false);
  if (isSelected) {
...
function useTabIndicator() {
  ...
  const isHorizontal = orientation === "horizontal";
  const isVertical = orientation === "vertical";
  const [rect, setRect] = (0, import_react153.useState)(() => {
    if (isHorizontal)
  ...
  const [hasMeasured, setHasMeasured] = (0, import_react153.useState)(false);
  useSafeLayoutEffect(() => {
...
function useTooltip(props = {}) {
  ...
  const enterTimeout = (0, import_react155.useRef)();
  const clearEnterTimeout = (0, import_react155.useCallback)(() => {
    if (enterTimeout.current) {
      clearTimeout(enterTimeout.current);
      enterTimeout.current = void 0;
    }
  }, []);
  const exitTimeout = (0, import_react155.useRef)();
  const clearExitTimeout = (0, import_react155.useCallback)(() => {
    if (exitTimeout.current) {
      clearTimeout(exitTimeout.current);
      exitTimeout.current = void 0;
    }
  }, []);
  const closeNow = (0, import_react155.useCallback)(() => {
    clearExitTimeout();
    onClose();
  }, [onClose, clearExitTimeout]);
  const dispatchCloseEvent = useCloseEvent(ref, closeNow);
  const openWithDelay = (0, import_react155.useCallback)(() => {
  ...
  const closeWithDelay = (0, import_react155.useCallback)(() => {
    clearEnterTimeout();
    const win = getWin(ref);
    exitTimeout.current = win.setTimeout(closeNow, closeDelay);
  }, [closeDelay, closeNow, clearEnterTimeout]);
  const onClick = (0, import_react155.useCallback)(() => {
    if (isOpen && closeOnClick) {
      closeWithDelay();
    }
  }, [closeOnClick, closeWithDelay, isOpen]);
  const onPointerDown = (0, import_react155.useCallback)(() => {
  ...
  const getTooltipPositionerProps = (0, import_react155.useCallback)(
    (props2 = {}, forwardedRef = null) => getPopperProps(
      {
        ...props2,
        style: {
  ...
  const getTooltipProps = (0, import_react155.useCallback)(
    (props2 = {}, ref2 = null) => {
      const styles = {
        ...props2.style,
        position: "relative",
...
var Tooltip = forwardRef((props, ref) => {
  ...
  let trigger;
  if (shouldWrap) {
    trigger = (0, import_jsx_runtime133.jsx)(
      chakra.span,
      {
        display: "inline-block",
        tabIndex: 0,
    ...
    const child = import_react156.Children.only(children);
    trigger = (0, import_react156.cloneElement)(
      child,
